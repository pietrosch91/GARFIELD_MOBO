...
Label(master, text="CH1 Threshold").grid(row=4)
Label(master, text="CH1 Pre Trigger").grid(row=5)
Label(master, text="CH1 Trigger Window").grid(row=6)

Label(master, text="CH2 Threshold").grid(row=8)
Label(master, text="CH2 Pre Trigger").grid(row=9)
Label(master, text="CH2 Trigger Window").grid(row=10)
...
for i in range(3 * N_CHANNELS):
	...
	entryList[i].grid(row=i + (i / N_CHANNELS) , column=1)
#Channel 0
...
#Channel 1
Button(master, text='Read', command=lambda: read_from_ipbus_reg("l1_cache_1.trigger_threshold",varList[3])).grid(
    row=4, column=3,  pady=4)
Button(master, text='Send', command=lambda: write_on_ipbus_reg("l1_cache_1.trigger_threshold", entryList[3])).grid(
    row=4, column=2,  pady=4)

Button(master, text='Read', command=lambda: read_from_ipbus_reg("l1_cache_1.pre_trigger",varList[4])).grid(
    row=5, column=3,  pady=4)
Button(master, text='Send', command=lambda: write_on_ipbus_reg("l1_cache_1.pre_trigger", entryList[4])).grid(
    row=5, column=2,  pady=4)

Button(master, text='Read', command=lambda: read_from_ipbus_reg("l1_cache_1.trigger_window",varList[5])).grid(
    row=6, column=3,  pady=4)
Button(master, text='Send', command=lambda: write_on_ipbus_reg("l1_cache_1.trigger_window", entryList[5])).grid(
...
#Channel 2
Button(master, text='Read', command=lambda: read_from_ipbus_reg("l1_cache_2.trigger_threshold",varList[6])).grid(
    row=8, column=3,  pady=4)
Button(master, text='Send', command=lambda: write_on_ipbus_reg("l1_cache_2.trigger_threshold", entryList[6])).grid(
    row=8, column=2,  pady=4)

Button(master, text='Read', command=lambda: read_from_ipbus_reg("l1_cache_2.pre_trigger",varList[7])).grid(
    row=9, column=3,  pady=4)
Button(master, text='Send', command=lambda: write_on_ipbus_reg("l1_cache_2.pre_trigger", entryList[7])).grid(
    row=9, column=2,  pady=4)

Button(master, text='Read', command=lambda: read_from_ipbus_reg("l1_cache_2.trigger_window",varList[8])).grid(
    row=10, column=3,  pady=4)
Button(master, text='Send', command=lambda: write_on_ipbus_reg("l1_cache_2.trigger_window", entryList[8])).grid(
...
l1 = Label(master, text="GCU 3").grid(row=16,column=2)
