           ...
           # print "OCCUPATION FIfo", occupied_current
            ...
            if count.value() != 0:
				...
				data_std  = int(std(data_to_plot))
                                trigger_window = buf[trailer_idx_a + 10]
                        ...
                        #if ((plot_count % plot_selector) == 0 and (  (data_std > 50) and data_std <100) ):
