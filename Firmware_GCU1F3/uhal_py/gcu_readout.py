...
if (selected_channel == "0"):
    import gcu_adu0 as gcu
elif (selected_channel == "1"):
    import gcu_adu1 as gcu
elif (selected_channel == "2"):
    import gcu_adu2 as gcu
else:
...
device = Config.get('IPBusParameters', 'GCUNode')
...
my_gcu.set_sample_count(TriggerWindow)
                    ...
                    while(len(buf) > BUFFER_TRESHOLD):
                        ...
                        if not trailer_idx_a:
                            ...
                            trailer_idx_b = seq_in_seq(
                                trailer, (list(buf)[trailer_idx_a + 1:]))
