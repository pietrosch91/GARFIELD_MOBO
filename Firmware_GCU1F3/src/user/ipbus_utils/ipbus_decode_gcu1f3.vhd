...
-- START automatically  generated VHDL the Tue Jul 21 15:40:55 2020 
  constant N_SLV_DSP_READOUT_CTRL: integer := 0;
  constant N_SLV_DSP_LOADER: integer := 1;
  constant N_SLV_DSP_IFACE_CTRL_CH0: integer := 2;
  constant N_SLV_DSP_IFACE_CTRL_CH1: integer := 3;
  constant N_SLV_DATA_MERGE: integer := 4;
  constant N_SLV_DSP_SIM_CH0: integer := 5;
  constant N_SLV_DSP_SIM_CH1: integer := 6;
  constant N_SLV_TRIGGER_MANAGER: integer := 7;
  constant N_SLV_IPBUS_FIFO_0: integer := 8;
  constant N_SLV_IPBUS_FIFO_1: integer := 9;
  constant N_SLV_IPBUS_FIFO_2: integer := 10;
  constant N_SLV_ADU_MANAGER: integer := 11;
  constant N_SLV_TEST_REG: integer := 12;
  constant N_SLV_COUNTER: integer := 13;
  constant N_SLV_L1_CACHE_0: integer := 14;
  constant N_SLV_L1_CACHE_1: integer := 15;
  constant N_SLV_L1_CACHE_2: integer := 16;
  constant N_SLV_USER_DATA: integer := 17;
  constant N_SLV_RAM: integer := 18;
  constant N_SLV_GPIO: integer := 19;
  constant N_SLV_DEBUG1: integer := 20;
  constant N_SLV_DEBUG2: integer := 21;
...
-- START automatically  generated VHDL the Tue Jul 21 15:40:55 2020 
    if    std_match(addr, "-----------------00001000000----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_DSP_READOUT_CTRL, IPBUS_SEL_WIDTH)); -- dsp_readout_ctrl / base 0x00000400 / mask 0x00007ff0
    elsif std_match(addr, "-----------------00001010000----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_DSP_LOADER, IPBUS_SEL_WIDTH)); -- dsp_loader / base 0x00000500 / mask 0x00007ff0
    elsif std_match(addr, "-----------------00001100000----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_DSP_IFACE_CTRL_CH0, IPBUS_SEL_WIDTH)); -- dsp_iface_ctrl_ch0 / base 0x00000600 / mask 0x00007ff0
    elsif std_match(addr, "-----------------00001100001----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_DSP_IFACE_CTRL_CH1, IPBUS_SEL_WIDTH)); -- dsp_iface_ctrl_ch1 / base 0x00000610 / mask 0x00007ff0
    elsif std_match(addr, "-----------------00001101000----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_DATA_MERGE, IPBUS_SEL_WIDTH)); -- data_merge / base 0x00000680 / mask 0x00007ff0
    elsif std_match(addr, "-----------------00001110000----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_DSP_SIM_CH0, IPBUS_SEL_WIDTH)); -- dsp_sim_ch0 / base 0x00000700 / mask 0x00007ff0
    elsif std_match(addr, "-----------------00001110001----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_DSP_SIM_CH1, IPBUS_SEL_WIDTH)); -- dsp_sim_ch1 / base 0x00000710 / mask 0x00007ff0
