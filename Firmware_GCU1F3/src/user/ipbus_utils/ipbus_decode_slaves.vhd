...
package ipbus_decode_slaves is

  constant IPBUS_SEL_WIDTH: positive := 5; -- Should be enough for now?
  subtype ipbus_sel_t is std_logic_vector(IPBUS_SEL_WIDTH - 1 downto 0);
  function ipbus_sel_decode(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t;
...
-- START automatically  generated VHDL the Thu May  3 15:36:57 2018 
  ...
  constant N_SLV_DAQ: integer := 4;
  constant N_SLAVES: integer := 5;
-- END automatically generated VHDL

    
end ipbus_decode_slaves;

package body ipbus_decode_slaves is

  function ipbus_sel_decode (addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t is
...
-- START automatically  generated VHDL the Thu May  3 15:36:57 2018 
    if    std_match(addr, "------------------00----------0-") then
      ...
      sel := ipbus_sel_t(to_unsigned(N_SLV_DAQ, IPBUS_SEL_WIDTH)); -- 
-- END automatically generated VHDL
