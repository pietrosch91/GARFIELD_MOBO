...
HD_PWD='/home/bini/GARFIELD_MOBO/fifo_prj/fifo_prj.runs/channel_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log channel_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source channel_fifo.tcl
